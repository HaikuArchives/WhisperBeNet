...
BubbleHelper* BubbleHelper::m_instance = 0;
...
BubbleHelper* BubbleHelper::Instance()
{
	if(!m_instance)
		m_instance = new BubbleHelper;
...
void BubbleHelper::Helper()
{
    ...
    textview->SetLowColor(255,255,132);
    textview->SetViewColor(255,255,132);
