...
//	ABSTRACT & PURPOSE																			
//																										
//	Once started, MouseWatcher will watch the mouse until the mouse buttons are all released,	
//	sending messages to the target BView (TargetView is specified as the target handler in
//	the BMessenger used to send the messages.  The BLooper == window of the target view is 
//	determined automatically by the BMessenger)
//
...
//
//	Once it is started, you can't stop it, but that shouldn't matter - the user will most
//	likely release the buttons soon, and you can interpret the events however you want.
//
